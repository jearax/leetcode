...
public class Solution {
   ...
   * 🧠 Cách 1 — Brute Force.
   *
   * Ý tưởng: duyệt mọi cặp chỉ số (i, j) với i &lt; j, trả về cặp đầu tiên có
   ...
   *
   * Ý tưởng: với mỗi nums[i], tra complement = target - nums[i] trong map; chưa
   * có thì lưu nums[i] → i vào map rồi đi tiếp.
   *
   * ⏱ Time: O(n) · 💾 Space: O(n).
   *
   * @param nums
